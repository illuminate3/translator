	...
	public function getPagesHtml()
	{
		...
		if ( $this->type == 'deleted' ) {
			foreach ($parents as $parent) {
				...
				$html .= "<a href='" . URL::to('admin/pages/' . $parent->id . '/restore') . "'>Restore</a> | ";
				$html .= "<a href='" . URL::to('admin/pages/' . $parent->id . '/destroy') . "' class='text-danger'>Delete Permanently</a></div></td>";
				$html .= "<td><a href='" . URL::to('admin/pages?author=' . $parent->user->id) . "'>" . $parent->user->first_name .' '. $parent->user->last_name . "</a></td>";
			...
			foreach ($parents as $parent) {
				$html .= "<tr class='hover-row'>";
				$html .= "<td><input type='checkbox' class='acheckbox' value='" . $parent->id . "'></td>";
				$html .= "<td><a href='" . URL::to('admin/pages/' . $parent->id . '/edit') . "'><strong>$parent->title</strong></a>";
				if ( $this->type == 'all' ) $html .= ! $parent->is_online ? "<strong> - Draft </strong>" : "";
				$html .= "<div class='visibility more-options'>";
				$html .= "<a href='" . URL::to('admin/pages/' . $parent->id . '/edit') . "'>Edit</a> | ";
				$html .= $parent->is_online ? "<a href='" . URL::to('scaffolding/'.$parent->slug) . "' target='_blank' >View</a>" : "<a href='" . URL::to('admin/pages/' . $hashids->encrypt($parent->id) . '/preview') . "' target='_blank'>Preview</a>";
				$html .= " | <a href='" . URL::to('admin/pages/' . $parent->id . '/delete') . "' class='text-danger'>Trash</a></div></td>";
				$html .= "<td><a href='" . URL::to('admin/pages?author=' . $parent->user->id) . "'>" . $parent->user->first_name .' '. $parent->user->last_name . "</a></td>";
				$html .= "<td><a href='" . URL::to('admin/pages/' . $parent->id) . "/versions' class='btn btn-default btn-circle btn-grad btn-sm'>$parent->version</a></td>";
				$html .= "<td><abbr title='" . $parent->created_at->format('D jS \\of M, Y H:i A') . "'>" . $parent->created_at->format('jS M, Y') . "</abbr></td>";
				$html .= "<td><abbr title='" . $parent->updated_at->format('D jS \\of M, Y H:i A') . "'>" . $parent->updated_at->diffForHumans() . "</abbr></td>";
				$html .= "</tr>";
	...
	public function getChildrenHTML($parent,$arrow)
	{
		...
		if ( $this->type == 'deleted' ) {
			foreach ($children as $child) {
				...
				$html .= "<div class='visibility more-options'>";
				$html .= "<a href='" . URL::to('admin/pages/' . $child->id . '/restore') . "'>Restore</a> | ";
				$html .= "<a href='" . URL::to('admin/pages/' . $child->id . '/destroy') . "' class='text-danger'>Delete Permanently</a></div></td>";
				$html .= "<td><a href='" . URL::to('admin/pages?author=' . $child->user->id) . "'>" . $child->user->first_name .' '. $child->user->last_name . "</a></td>";
			...
			foreach ($children as $child) {
				$html .= "<tr class='hover-row'>";
				$html .= "<td><input type='checkbox' class='acheckbox' value='" . $child->id . "'></td>";
				$html .= "<td>$arrow <a href='" . URL::to('admin/pages/' . $child->id . '/edit') . "'>$child->title</a>";
				if ( $this->type == 'all' ) $html .= ! $child->is_online ? "<strong> - Draft </strong>" : "";
				$html .= "<div class='visibility more-options'>";
				$html .= "<a href='" . URL::to('admin/pages/' . $child->id . '/edit') . "'>Edit</a> | ";
				$html .= $child->is_online ? "<a href='" . URL::to('scaffolding/'.$child->slug) . "' target='_blank'>View</a>" : "<a href='" . URL::to('admin/pages/' . $hashids->encrypt($child->id) . '/preview') . "' target='_blank'>Preview</a>";
				$html .= " | <a href='" . URL::to('admin/pages/' . $child->id . '/delete') . "' class='text-danger'>Trash</a></div></td>";
				$html .= "<td><a href='" . URL::to('admin/pages?author=' . $child->user->id) . "'>" . $child->user->first_name .' '. $child->user->last_name . "</a></td>";
				$html .= "<td><a href='" . URL::to('admin/pages/' . $child->id) . "/versions' class='btn btn-default btn-circle btn-grad btn-sm'>$child->version</a></td>";
				$html .= "<td><abbr title='" . $child->created_at->format('D jS \\of M, Y H:i A') . "'>" . $child->created_at->format('jS M, Y') . "</abbr></td>";
				$html .= "<td><abbr title='" . $child->updated_at->format('D jS \\of M, Y H:i A') . "'>" . $child->updated_at->diffForHumans() . "</abbr></td>";
				$html .= "</tr>";
