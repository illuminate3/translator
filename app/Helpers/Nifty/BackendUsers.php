...
class BackendUsers
{
	public static function getUsersHtml($users)
	{
		...
		foreach ($users as $user) {
			...
			$pagesNum = count($user->pages);
			$postsNum = count($user->posts);
			...
			$html .= "</td>";
			if ( $pagesNum )
				$html .= "<td><a href='" . URL::to('dashboard/pages?author=' . $user->id) . "' class='btn btn-default btn-circle btn-grad btn-sm'>$pagesNum</a></td>";
			else
				$html .= "<td><a href='" . URL::to('dashboard/pages?author=' . $user->id) . "' class='btn btn-default btn-circle btn-grad btn-sm disabled'>$pagesNum</a></td>";		
			if ( $postsNum )
				$html .= "<td><a href='" . URL::to('dashboard/blog?author=' . $user->id) . "' class='btn btn-default btn-circle btn-grad btn-sm'>$postsNum</a></td>";
			else
				$html .= "<td><a href='" . URL::to('dashboard/blog?author=' . $user->id) . "' class='btn btn-default btn-circle btn-grad btn-sm disabled'>$postsNum</a></td>";
