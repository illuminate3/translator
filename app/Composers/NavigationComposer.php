...
//dd($navigation);
	...
	{
//dd('getNodeForCurrentRoute');
		$currentUri = \Request::path();
//dd($currentUri);
		if ($navItem = NavItem::where('uri','=',$currentUri)->orWhere('uri','=','/'.$currentUri)->first())
//		if ($navItem = NavItem::where('link','=',$currentUri)->orWhere('link','=','/'.$currentUri)->first())
		{
dd($navItem);
			return $navItem;
		}
	...
	{
//dd('getAncestorNodeForCurrentRoute');
