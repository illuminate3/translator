    ...
    <div class="col-lg-12">
        <div class="box info">
            <header>
                ...
                <h5>Edit Category</h5>
                <div class="toolbar">
                    <a class="btn btn-default btn-sm btn-flat" href="{{URL::to('dashboard/blog/categories/create')}}"><span class="fa fa-pencil"></span> New Category</a>
                </div>                
            </header>
        </div><!-- /.box -->
    </div>
    <div class="col-md-12">
        {{Form::model($category, ["url" => "dashboard/blog/categories/$category->id/update", 'class' => 'form-horizontal'])}}  
            <div class="col-md-9">                 
