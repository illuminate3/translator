...
@section('page')
    ...
    <div class="col-md-12">
        {{Form::model($post, ["url" => "dashboard/blog/posts/$post->id/update", 'class' => 'form-horizontal'])}}  
            <div class="col-md-9">                 
            ...
            <div class="col-md-2 col-md-offset-1">
                <div class="form-group">
                    ...
                    {{ Jamesy\ModelCheckboxGroup::generateHtml($categories, count(Input::old('categories')) ? Input::old('categories') : $post->categories, 'categories[]') }} 
                </div> 
