...
@section('page')
    <div class="col-lg-12">
        <div class="box info">
            <header>
                ...
                <h5>Deleted Posts</h5>
                <div class="toolbar">
                    <a class="btn btn-default btn-sm btn-flat" href="{{URL::to('dashboard/pages/create')}}"><span class="fa fa-pencil"></span> New Post</a>
                </div>                  
            </header>
        </div><!-- /.box -->
    </div>
    ...
    <div class="col-md-12">
        <div class="btn-group page-options">
            <a class="btn btn-metis-5 btn-rect btn-line" role="button" href="{{ URL::to('dashboard/blog/posts') }}">All ({{ $nums['allNotDeletedNum'] }})</a>
            <a class="btn btn-metis-5 btn-rect btn-line" role="button" href="{{ URL::to('dashboard/blog/posts/published') }}">Published ({{ $nums['publishedNum'] }})</a>
            <a class="btn btn-metis-5 btn-rect btn-line" role="button" href="{{ URL::to('dashboard/blog/posts/drafts') }}">Drafts ({{ $nums['draftsNum'] }})</a>
            <a class="btn btn-metis-5 btn-rect disabled" href="{{ URL::to('dashboard/blog/posts/trash') }}">Trash ({{ $nums['deletedNum'] }})</a>
        </div>
    </div>
    ...
    <div class="col-md-12 optionsDiv opacity">
        ...
        <div class="row">
            <div class="col-sm-3 col-md-2">
                ...
                <div class="form-group">
                    <input type="hidden" id="bulkRestoreUrl" value = "{{ URL::to('dashboard/blog/posts/bulk-restore') }}" />
                    <input type="hidden" id="bulkDestroyUrl" value = "{{ URL::to('dashboard/blog/posts/bulk-destroy') }}" />
