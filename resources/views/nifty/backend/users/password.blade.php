        ...
        {{Form::open(['url' => 'dashboard/users/profile/password', 'class' => 'form-horizontal', 'role' => 'form'])}}  
            <div class="col-md-9">                 
                <div class="form-group {{ Session::has('existing_pass_error') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                        {{ Form::password('existing_password', ['id' => 'existing_password', 'class' => 'form-control input-lg']) }}
                ...
                <div class="form-group {{ $errors->first('new_password') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                        {{ Form::password('new_password', ['id' => 'new_password', 'class' => 'form-control input-lg']) }}
                    </div>                    
                </div>
                <div class="form-group {{ $errors->first('new_password') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                        {{ Form::password('new_password_confirmation', ['id' => 'new_password_confirmation', 'class' => 'form-control input-lg']) }}
                    </div>                    
                </div> 
