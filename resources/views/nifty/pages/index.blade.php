...
@section('page')
    ...
    <div class="col-md-12">
        <div class="btn-group page-options">
            <a class="btn btn-metis-5 btn-rect {{ $type == 'All' ? 'disabled' : 'btn-line' }}" role="button" href="{{ URL::to('dashboard/pages') }}">All ({{ $nums['allNotDeletedNum'] }})</a>
            <a class="btn btn-metis-5 btn-rect {{ $type == 'Published' ? 'disabled' : 'btn-line' }}" role="button" href="{{ URL::to('dashboard/pages/published') }}">Published ({{ $nums['publishedNum'] }})</a>
            <a class="btn btn-metis-5 btn-rect {{ $type == 'Drafts' ? 'disabled' : 'btn-line' }}" role="button" href="{{ URL::to('dashboard/pages/drafts') }}">Drafts ({{ $nums['draftsNum'] }})</a>
            <a class="btn btn-metis-5 btn-rect btn-line" href="{{ URL::to('dashboard/pages/trash') }}">Trash ({{ $nums['deletedNum'] }})</a>
        </div>
    </div>
    ...
    <div class="col-md-12 optionsDiv opacity">
        ...
        <div class="row">
            <div class="col-sm-3 col-md-2">
                ...
                <div class="form-group">
                    <input type="hidden" id="bulkPublishUrl" value = "{{ URL::to('dashboard/pages/bulk-publish') }}" />
                    <input type="hidden" id="bulkDeleteUrl" value = "{{ URL::to('dashboard/pages/bulk-delete') }}" />
                    <input type="hidden" id="bulkDraftUrl" value = "{{ URL::to('dashboard/pages/bulk-draft') }}" />
